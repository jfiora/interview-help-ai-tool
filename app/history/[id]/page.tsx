            ...
            <main className="min-h-screen bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="text-center py-16">
                        ...
                        <p className="mt-1 text-gray-500">The session you're looking for doesn't exist.</p>
                        <div className="mt-6">
                            <Link
                                href="/history"
        ...
        <main className="min-h-screen bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <div className="flex items-center space-x-4 mb-2">
                                ...
                                <h1 className="text-3xl font-bold text-gray-900">{sessionData.session.session_name}</h1>
                            </div>
                            <p className="text-gray-600 text-lg">{sessionData.session.job_title}</p>
                        </div>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-gray-900">{formatDate(sessionData.session.created_at)}</p>
                        </div>
                        <div>
                            <h3 className="text-sm font-medium text-gray-500">Model Used</h3>
                            <p className="mt-1 text-sm text-gray-900">{sessionData.session.model_used}</p>
                        </div>
                        <div>
                            <h3 className="text-sm font-medium text-gray-500">Questions</h3>
                            <p className="mt-1 text-sm text-gray-900">{sessionData.session.total_questions}</p>
                        </div>
                        <div>
                            <h3 className="text-sm font-medium text-gray-500">Estimated Cost</h3>
                            <p className="mt-1 text-sm text-gray-900">{formatCost(sessionData.session.estimated_cost)}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    <h2 className="text-xl font-semibold text-gray-900">Interview Questions & Answers</h2>
                                    ...
                                    <div className="flex-1">
                                        <div className="bg-blue-50 rounded-lg p-4">
                                            <div className="flex items-center justify-between mb-2">
                                                <p className="text-gray-900 font-medium">Interviewer</p>
                                                <div className="flex gap-2">
                                                    <span className={`px-2 py-1 text-xs rounded-full ${
                                                        item.question_type === 'technical'
                                                            ? 'bg-blue-100 text-blue-800'
                                                            : item.question_type === 'behavioral'
                                ...
                                <div className="ml-11">
                                    <div className="mt-4 p-4 bg-green-50 rounded-lg border border-green-200">
                                        ...
                                        <div className="prose prose-sm max-w-none">
                                            ...
                                            {item.answer.key_points && item.answer.key_points.length > 0 && (
                                                <div className="mb-3">
                                                    <h5 className="text-sm font-medium text-green-800 mb-2">Key Points:</h5>
                                                    <ul className="list-disc list-inside space-y-1">
                                                        {item.answer.key_points.map((point, pointIndex) => (
                                                            <li key={pointIndex} className="text-sm text-green-700">
                                                                {point}
                                                            </li>
                                                        ))}
                                                    </ul>
                                            ...
                                            {item.answer.tips && (
                                                <div className="bg-white rounded p-3 border border-green-200">
                                                    ...
                                                    <p className="text-sm text-green-700">{item.answer.tips}</p>
                                                </div>
                                            )}
                                        </div>
                                    </div>
